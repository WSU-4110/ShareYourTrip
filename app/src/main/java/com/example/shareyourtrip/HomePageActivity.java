...
public class HomePageActivity extends AppCompatActivity {
    ...
    private void preparePostData(){
        ...
        post = new Post("Chicago", "IL", "Museum", "Family Fun at Shedd's Aquarium", "The Shedd is leading the game in terms of accessibility! I was treated to a very lovely dolphin/wild life show that was sensory friendly. Wish more museums were on the same level. \n" +
                "\n" +
                "They also house a great variety of animals in this building with tons of info available if you're curious. The layout is very convenient and the staff is very helpful. Highly recommend if you're looking to explore one of Chicago's many museums.", "Sally H.", "12/1/2020");
        favList.add(post);

        post = new Post("City", "State", "Category", "Title", "Desc", "Author", "Date");
        favList.add(post);
